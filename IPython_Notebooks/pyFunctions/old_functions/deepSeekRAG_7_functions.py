...
class SafeFish(BaseModel):
    fisheries_adaptation_bool: bool = Field(default=True,description= "Does this research study a fisheries climate change adaptation action? If yes, reply True and if no, reply False. If the information is unavailable or unclear, reply with True.")
...
InterventionInstiutional_dict = {
        ...
        "variable faissK": 10,
        "variable question": """
        Respond with a List of all SOCIO-INSTITUTIONAL actions/strategies to help marine fisheries adapt to climate change that are studied in the article. In general, actions relevant to changes in POLICY, PRACTICE, MANAGEMENT, LAW, ECONOMICS/FINANCE or SOCIAL BEHAVIOUR will fall into one of these categories. List elements must be selected from the allowed values defined below. If no eligible socio-behavioural actions are identified, respond with an empty list.
        
        **Allowed value definitions**:
        - "Institutional": Changing institutional practices, polcies, laws, legislation (e.g. ocean governance, institutional agreements, marine spatial planning and integrated coastal zone managmeent). 
        - "Fisheries management": Management of fisheries or changing fishing practices  (e.g. co-management, adaptive or ecosystem-based management, community-based management, activities within the purview of fisheries management (including population assessments, fish stocking, habitat restoration and design))
        ...
        - "Economic": Actions that use economic or financial mechanisms. These include: insurance, subsidies, financial incentives, compensation schemes, market-based instruments, alternative value chains, finance or credit, economic diversification (e.g. new seafood products, domestic vs export markets, climate-resilient supply chains). 
...
StudyMethod_dict = {
        ...
        **Allowed value definitions**:
        ...
        -'Observation': Direct observational methods where researchers record behaviors, patterns, or phenomena without manipulation or direct interaction. This includes ecological field surveys but NOT surveys/questionnaires in social science research. 
