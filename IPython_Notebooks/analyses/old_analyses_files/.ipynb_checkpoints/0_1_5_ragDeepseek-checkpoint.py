...
with open(f'/home/dveytia/IPython_Notebooks/Product_4/pyFunctions/deepSeekRAG_5_functions.py') as f:
    exec(f.read())
...
faiss_directory = f'{dataFolder}/data/derived-data/testList_vectorstores_partitioned_bgem3/'
...
# Batching parameters
max_concurrent_tasks = 2  # concurrency limit
batch_size = 25
max_failed_id_retries = 10 # number of times to retry a failed id in a batch
codeMaxRetries = 5 # number of times to retry each variable if parsing fails
